"""
Django settings for investafrik project.
...
WSGI_APPLICATION = 'investafrik.wsgi.application'
ASGI_APPLICATION = 'investafrik.asgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='INVESTAFRIKDB'),
